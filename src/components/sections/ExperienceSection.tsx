...
const experiences = [
    {
        ...
        company: "École High Tech — Rabat, Maroc",
        description: "Formation supérieure spécialisée en ingénierie informatique et développement logiciel.",
        tech: ["Génie Informatique", "Architecture Web", "Full-Stack"],
    },
    {
        year: "2024 – Présent",
        title: "Freelance Full-Stack Developer",
        company: "Freelance",
        description: "Développement d'applications web modernes avec React, Next.js, Node.js et MongoDB. Création d'interfaces responsives et animées avec TailwindCSS, GSAP et Framer Motion.",
        tech: ["React", "Next.js", "Node.js", "MongoDB", "GSAP", "Framer Motion"],
    },
    {
        year: "Mars 2024 – Mai 2024",
        title: "Stagiaire Développeur Web",
        company: "MarsaMaroc — Safi, Maroc",
        description: "Développement d'une application web interne pour le suivi et la gestion des employés. Mise en place de l'authentification par rôles avec Laravel Sanctum, API REST et MySQL normalisé.",
        tech: ["React.js", "Laravel", "MySQL", "Tailwind CSS"],
    },
    {
        year: "2022 – 2024",
        title: "Technicien Spécialisé en Développement Digital",
        company: "ISTA NTIC — Safi, Maroc",
        description: "Option Full-Stack. Développement web full-stack, bases de données MySQL, modélisation UML et méthodologies Agile/Scrum.",
        tech: ["React.js", "Laravel", "MySQL", "JavaScript", "PHP"],
    },
    {
        year: "2020 – 2021",
        title: "Baccalauréat en Sciences Physiques",
        company: "Lycée Mohamed Ben Hassan El Ouazzani — Safi, Maroc",
        description: "Formation scientifique axée sur la physique-chimie et les mathématiques.",
        tech: ["Physique", "Chimie", "Mathématiques"],
    },
];
