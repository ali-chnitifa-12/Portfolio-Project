        ...
        >
            ...
            >
                ...
                <div ref={contentRef} className="text-center lg:text-left z-20 transform-style-3d">
                    {/* Availability Badge */}
                    <div className="w-fit mx-auto lg:mx-0 mb-4 sm:mb-5 flex items-center gap-2 px-4 py-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 backdrop-blur-sm">
                        <span className="relative flex h-2 w-2">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" />
                            <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-400" />
                        </span>
                        <span className="text-[10px] sm:text-xs text-emerald-400 font-mono tracking-wider uppercase">Open to Opportunities</span>
                    </div>
                    <p
                        ref={subtitleRef}
                    ...
                    >
                        ...
                        <span>Hi I&apos;m Ali — Full-Stack Developer<br className="sm:hidden" /> (React &amp; Laravel)</span>
                    </p>
                    <h1
                        ref={titleRef}
