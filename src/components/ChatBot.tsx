...
const knowledgeBase: { id: string; question: string; answer: string; tags: string[] }[] = [
    {
        ...
        tags: ["who", "name", "about", "yourself", "introduce", "ali", "chnitifa"],
    },
    {
        id: "projects",
        ...
        tags: ["project", "built", "work", "portfolio", "app", "application", "built", "made"],
    },
    {
        id: "ecommerce",
        ...
        tags: ["ecommerce", "e-commerce", "shop", "store", "commerce", "cart", "shopping", "flagship", "main"],
    },
    {
        id: "stack",
        question: "What technologies do you use?",
        answer: "My core stack is **React** (frontend) and **Laravel** (backend) with **MySQL** as my database. I'm also comfortable with Next.js, Node.js, Redux, TailwindCSS, REST APIs, and Git. For animations I use GSAP. I work with Postman for API testing.",
        tags: ["tech", "technologies", "stack", "use", "skills", "know", "languages", "tools", "framework"],
    },
    {
        id: "hire",
        ...
        tags: ["hire", "why", "value", "choose", "pick", "good", "benefit", "strengths"],
    },
    {
        id: "experience",
        question: "Do you have any professional experience?",
        answer: "Yes! I did an internship at **MarsaMaroc** (March – May 2024) where I developed an internal web application for employee management. That project involved building a REST API with Laravel, implementing role-based authentication, and integrating a React frontend. Outside of that, I've built multiple full-stack projects independently.",
        tags: ["experience", "professional", "work", "job", "internship", "worked", "marsa"],
    },
    {
        id: "available",
        question: "Are you available? Open to work?",
        answer: "Yes, absolutely! I'm currently available for Junior Developer roles (full-time or contract) and selective freelance opportunities. I'm ready to start immediately and can adapt to both remote and on-site environments. Don't hesitate to reach out!",
        tags: ["available", "open", "hire", "looking", "work", "freelance", "remote", "start", "ready"],
    },
    {
        id: "contact",
        ...
        tags: ["contact", "email", "reach", "linkedin", "github", "message", "talk", "touch"],
    },
    {
        id: "learning",
        ...
        tags: ["learn", "studying", "currently", "improving", "grow", "future", "next"],
    },
    {
        id: "cv",
        ...
        tags: ["cv", "resume", "download", "pdf", "curriculum"],
    },
    {
        id: "react",
        question: "How good are you with React?",
        answer: "React is my primary frontend tool. I build with Hooks (useState, useEffect, useContext, useRef), manage state with Redux, and I'm comfortable with performance patterns like memo, lazy loading, and code splitting. I've used it in multiple production-level projects including the E-Commerce platform and this portfolio itself.",
        tags: ["react", "frontend", "hooks", "redux", "component"],
    },
    {
        id: "laravel",
        question: "Tell me about your Laravel experience",
        answer: "Laravel is my backend of choice. I've used it to build RESTful APIs with proper resource routing, Eloquent ORM for database interactions, middleware for authentication and authorization, and Sanctum/JWT for secure auth flows. My E-Commerce backend is entirely built with Laravel.",
        tags: ["laravel", "backend", "php", "api", "eloquent", "server"],
    },
    {
        id: "database",
        question: "What databases have you worked with?",
        answer: "My primary database is **MySQL** — I design normalized schemas, write complex queries, and manage migrations with Laravel. I've also worked with **MongoDB** for document-based storage in Node.js projects. I understand indexing, relationships, and query optimization.",
        tags: ["database", "mysql", "mongodb", "sql", "db", "data", "storage"],
    },
    {
        id: "api",
        question: "Have you built REST APIs?",
        answer: "Yes, REST API design is one of my core skills. I've designed and built full APIs in Laravel — including resource endpoints, authentication middleware, request validation, and JSON response formatting. I test with Postman and follow RESTful conventions (GET, POST, PUT, DELETE, status codes, etc.).",
        tags: ["api", "rest", "endpoint", "backend", "request", "response", "postman"],
    },
    {
        id: "education",
        question: "What's your educational background?",
        answer: "I hold a **Diploma in Digital Development** from ISTA NTIC Safi (2022–2024). My curriculum covered full-stack web development, databases, UML modeling, and Agile/Scrum methodologies. I complemented my degree with intensive self-study and real project-building.",
        tags: ["education", "degree", "school", "study", "diploma", "university", "background"],
    },
    {
        id: "location",
        question: "Where are you located?",
        answer: "I'm based in **Safi, Morocco**. I'm fully open to remote work globally, and I'm also willing to relocate for the right opportunity. Time zone is GMT+1.",
        tags: ["location", "where", "morocco", "safi", "remote", "relocate", "based"],
    },
    {
        id: "softskills",
        question: "What are your soft skills?",
        answer: "I'm a fast learner who thrives in problem-solving environments. I'm comfortable working solo or in teams, I communicate clearly (in Arabic, French, and English), and I practice Agile/Scrum methodologies. I'm detail-oriented but also know when to ship.",
        tags: ["soft", "skills", "personality", "team", "communication", "agile", "scrum", "work"],
    },
    {
        id: "salary",
        question: "What salary are you expecting?",
        answer: "I'm flexible on compensation and open to discussing what's fair based on the role, company, and responsibilities. My focus right now is finding a team where I can contribute and grow rapidly. Let's connect and talk numbers directly!",
        tags: ["salary", "compensation", "pay", "money", "expect", "rate"],
    },
    {
        id: "hotel",
        question: "Tell me about your hotel booking app",
        answer: "The **Luxury Hotel Engine** is a frontend-focused project where I built a premium reservation system using React, Redux, GSAP, and TailwindCSS. It features a cinematic UI with 3D room tour animations, a complex 5-step booking flow with real-time state synchronization, and persistent booking state across sessions.",
        tags: ["hotel", "booking", "reservation", "luxury", "room"],
    },
    {
        id: "github",
        question: "Where can I see your code?",
        answer: "All my public projects are on GitHub: **github.com/ali-chnitifa-12**. You'll find the source code for the E-Commerce platform, hotel booking app, and other personal projects there. Feel free to browse and leave a star if something catches your eye! ⭐",
        tags: ["github", "code", "source", "repository", "repo", "open source", "see"],
    },
];
